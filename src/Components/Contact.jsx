...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3ff93700-f7b4-4401-b8e2-86460997b4f6");
  ...
  return (
    ...
    overflow-hidden' id='Contact'>
      ...
      max-w-80 mx-auto'> Ready to make a move ? Let's build your future together</p>

      <form onSubmit={onSubmit}ssName='max-w-2xl mx-auto text-gray-600 pt-8' action="">
        <div className='flex flex-wrap'>
            ...
            py-3 px-4 mt-2' type="text" name='Name' placeholder='Your name' required />
                ...
                Your Email <input className='w-full border border-gray-300 rounded
...
<button className='bg-blue-600 text-white py-0 px-12 mb-10
